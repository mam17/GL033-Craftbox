...
public class MessageBubbleView extends RelativeLayout {
    ...
    public MessageBubbleView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setCornerRadius(a.getDimensionPixelSize(R.styleable.MessageBubbleView_cornerRadiusBBV, 0));
    ...
    public void setBubbleColor(int color) {
        setBubbleColor(ColorStateList.valueOf(color));
    }
    ...
    @SuppressWarnings("unused")
    public void setStroke(boolean enabled, int color, float width) {
        final BackgroundDrawable background = getBackgroundDrawable();
        background.setStroke(enabled, color, width);
    }
    ...
    private static class BackgroundDrawable extends Drawable {
        ...
        public void draw(@NonNull Canvas canvas) {
            ...
            if (mStrokeEnabled && mStrokeWidth > 0) {
                canvas.drawPath(mBubblePath, mStrokePaint);
            }
        }
        ...
        void setCaretPosition(@CaretPosition int position, int absolute) {
        ...
        void setStroke(boolean enabled, int color, float width) {
