package com.grl.sms_wa.ui.components.themes.activity
...
import com.grl.sms_wa.databinding.ActivityThemeStartBinding
import com.grl.sms_wa.ui.main.func.theme.ThemesViewModel
...
@AndroidEntryPoint
class ThemeStartActivity : BaseActivity<ActivityThemeStartBinding>(ActivityThemeStartBinding::inflate) {
    ...
    override fun initView() {
        binding.toolbarThemeStart.apply {
        ...
        themeAdapter.setOnItemClick { _, position ->
            ...
            themeDetailLauncher.launch(
                Intent(this, GetThemesActivity::class.java).apply {
                    putExtra(
                    ...
                    putExtra(Constant.EXTRA_THEME_FROM_START, true)
                }
            )
        }
    }
    ...
    private fun applyCurrentTheme() {
        ...
        binding.toolbarThemeStart.tvTitle.setTextColor(mainColor)
        binding.toolbarThemeStart.btnBack.tintColor(mainColor)
        binding.llNoData.tvBodyNoData.setTextColor(mainColor)
        categoryAdapter.setTheme(viewModel.themesOfSelectedCategory.value.firstOrNull())
    }

    private fun applyToolbarInsets(view: View) {
